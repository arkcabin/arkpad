...
export class YoutubeNodeView implements NodeView {
  ...
  constructor(node: PMNode, view: EditorView, getPos: () => number | undefined) {
    ...
    this.dom.className = "ark-youtube-node-view";
    ...
    this.container.className = "ark-youtube-container";
    this.container.style.width = "100%";

    // 3. Wrapper
    this.wrapper = document.createElement("div");
    this.wrapper.className = "ark-youtube-wrapper";
    ...
    // 4. Responsive Video Outer Container
    const aspectContainer = document.createElement("div");
    aspectContainer.style.position = "relative";
    aspectContainer.style.width = "100%";
    aspectContainer.style.paddingBottom = "56.25%"; // 16:9 standard aspect ratio
    aspectContainer.style.borderRadius = "8px";
    aspectContainer.style.overflow = "hidden";
    aspectContainer.style.boxShadow = "0 4px 6px -1px rgba(0,0,0,0.1)";

    // 5. Iframe
    this.iframe = document.createElement("iframe");
    const src = node.attrs.src;
    this.iframe.src = getYoutubeEmbedUrl(src) || src;
    ...
    // 6. Iframe Overlay (Prevents iframe from stealing mouse drag-resizing events)
    this.overlay = document.createElement("div");
    this.overlay.className = "ark-youtube-iframe-overlay";
    ...
    aspectContainer.appendChild(this.iframe);
    aspectContainer.appendChild(this.overlay);
    this.wrapper.appendChild(aspectContainer);
  ...
  selectNode() {
    this.overlay.style.boxShadow = "0 0 0 3px var(--ark-primary, #7c3aed)";
    this.createHandles();
    this.createToolbar();
  }
  ...
  private createHandles() {
    ...
    positions.forEach((pos) => {
      ...
      handle.className = `ark-youtube-resizer-dot ark-resizer-${pos}`;
  ...
  private createToolbar() {
    ...
    this.toolbar.className = "ark-youtube-toolbar";
