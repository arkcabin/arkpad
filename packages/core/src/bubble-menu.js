...
export class BubbleMenuView {
    ...
    updatePosition() {
        ...
        this.rafId = requestAnimationFrame(() => {
            if (this.view.isDestroyed || !this.element)
                return;
