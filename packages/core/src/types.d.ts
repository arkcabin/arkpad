...
export type ArkpadCommand = Command | ((...args: any[]) => Command) | ((...args: any[]) => (props: ArkpadCommandProps) => boolean | Promise<boolean>);
...
export interface ExtensionConfig<Options = any, Storage = any> {
    ...
    onUpdate?: (this: ExtensionContext<Options, Storage>, props: {
        editor: ArkpadEditorAPI;
    }) => void;
    onTransaction?: (this: ExtensionContext<Options, Storage>, props: {
        editor: ArkpadEditorAPI;
        transaction: Transaction;
    }) => void;
    onInterceptor?: (this: ExtensionContext<Options, Storage>, props: {
        editor: ArkpadEditorAPI;
        transaction: Transaction;
...
export type NodeViewConstructor = (new (node: PMNode, view: EditorView, getPos: () => number | undefined, decorations: any) => NodeView) | ((node: PMNode, view: EditorView, getPos: () => number | undefined, decorations: any) => NodeView);
