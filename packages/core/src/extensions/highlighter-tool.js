...
export const HighlighterTool = Extension.create({
    ...
    addCommands() {
        return {
            setHighlighterTool: (options) => (props) => {
        ...
        return [
            new Plugin({
                ...
                appendTransaction: (transactions, oldState, newState) => {
                    ...
                    if (transactions.some(tr => tr.getMeta("highlighter-tool-apply")))
                        return null;
