...
<FeatureDemo
  ...
  commands={[
    { label: "Bold", command: "toggleBold", isActive: "bold", icon: "Bold" },
    { label: "Italic", command: "toggleItalic", isActive: "italic", icon: "Italic" },
    { label: "Underline", command: "toggleUnderline", isActive: "underline", icon: "Underline" },
    { label: "Strike", command: "toggleStrike", isActive: "strike", icon: "Strike" },
    { label: "Code", command: "toggleCode", isActive: "code", icon: "Code" },
