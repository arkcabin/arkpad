...
<FeatureDemo
  feature="eraser-tool"
  content="<p>Click the eraser icon below to activate the eraser tool, then drag-select over <mark style='background-color: #ffff00'>this highlighted text</mark> or <mark style='background-color: #ff9800'>this orange highlight</mark> to strip formatting in real-time!</p>"
  commands={[
    { label: "Eraser Mode", command: "toggleEraserTool", isActive: "eraserTool", icon: "Eraser" },
  ]}
/>
