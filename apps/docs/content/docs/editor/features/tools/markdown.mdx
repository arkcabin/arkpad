...
<FeatureDemo
  feature="markdown"
  content="<p>Try pasting some raw Markdown text (e.g. <code># Header\n\nSome **bold** text</code>) into the editor below to see it automatically convert into rich formatting!</p>"
  commands={[]}
/>
