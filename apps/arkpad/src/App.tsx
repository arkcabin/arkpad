...
export function App() {
  const editor = useArkpadEditor({
    ...
    content:
      "<h1>Welcome to Arkpad</h1><p>This is the full editor showcase. Explore individual extensions in the sidebar to see how each module works in isolation.</p><p>Arkpad is built for performance and modularity.</p>",
  });
          ...
          <div className="max-w-4xl mx-auto px-6 py-12 space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-sm text-[var(--text-muted)]">
                Test the entire @arkpad/starter-kit in a unified environment.
              </p>
            </div>
            ...
            <div className="border border-[var(--border)] rounded-none bg-[var(--bg-main)]">
              <div className="h-12 px-3 border-b border-[var(--border)] flex items-center gap-1">
                ...
                <MenuButton command="toggleBulletList" name="bulletList">
